            ...
            <div className="flex flex-wrap-reverse justify-center my-20 gap-16">
                ...
                <div>
                    ...
                    <button
                        ...
                        className="bg-blue-700 hover:bg-blue-900 text-white px-4 py-2 rounded-md mt-2">Pay on Delivery</button>
                    <button className="bg-gray-700 hover:bg-gray-900 text-white px-4 py-2 rounded-md mt-2 ms-6">Insta Pay</button>
                </div>
            </div>
